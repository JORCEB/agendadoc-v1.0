...
class AgendarViewSecretaria(View):
    def get(self, request):
        try:
            ...
            # Manejar el caso en el que se encuentran múltiples objetos
            # Por ejemplo, obtener el primer objeto encontrado
            paciente = Pacientes.objects.filter(IdUsuario=request.user).first()
